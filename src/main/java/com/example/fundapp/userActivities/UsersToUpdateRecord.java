...
public class UsersToUpdateRecord extends AppCompatActivity implements UserAdapter.onItemClickListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_users_to_update_record);
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            userAdapter = new UserAdapter(UsersToUpdateRecord.this,userRetrieveData);
            progressDialog.dismiss();
            recyclerView.setAdapter(userAdapter);
            userAdapter.setOnClickListner(UsersToUpdateRecord.this);
        }
    ...
    public void sendToStart()
    {
        ...
        Intent i = new Intent(UsersToUpdateRecord.this,MainActivity.class);
    ...
    public void onItemClick(int position) {
        Intent AMAintent = new Intent(this,UpdatePaymentRecord.class);
