...
public class UsersToShowPayments extends AppCompatActivity implements UserAdapter.onItemClickListner{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_users_to_show_payments);
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            userAdapter = new UserAdapter(UsersToShowPayments.this,userRetrieveData);
            progressDialog.dismiss();
            recyclerView.setAdapter(userAdapter);
            userAdapter.setOnClickListner(UsersToShowPayments.this);
        }
    ...
    public void sendToStart()
    {
        ...
        Intent i = new Intent(UsersToShowPayments.this,MainActivity.class);
    ...
    public void onItemClick(int position) {
        Intent AMAintent = new Intent(this,PaymentsShow.class);
